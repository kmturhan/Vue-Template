					...
					<!---->
						...
						<div class="pa-6 white--text green-gradient graphDesign" v-if="openDeviceLength != 0">
							<div class="d-custom-flex align-items-center">
								...
								<span class="d-inline-block font-sm fw-bold">Toplam Açık Ekran Sayısı : {{ openDeviceLength }}</span>
							</div>
						...
						<span class="d-inline-block font-sm fw-bold" style="margin-left:10px;">Açık Ekran Yoktur</span>
							</div>
							<div class="d-custom-flex align-items-center justify-space-between">
					...
					<!---->
						...
						<div class="pa-6 white--text red-gradient graphDesign" v-if="closeDeviceLength != 0">
							<div class="d-custom-flex align-items-center">
								...
								<span class="d-flex font-sm fw-bold">Toplam Kapalı Ekran Sayısı : {{ closeDeviceLength }}</span>
                        ...
                        <span class="d-inline-block font-sm fw-bold">Kapalı Ekran Yoktur</span>
							</div>
							<div class="d-custom-flex align-items-center justify-space-between">
								<span class="fw-bold"></span>
							</div>
					...
					<!---->
						...
						<div class="pa-6 white--text red-gradient graphDesign">
							<div class="d-custom-flex align-items-center">
								...
								<span class="d-flex font-sm fw-bold justify-center" style="width:100%;">Ulaşılamayan Ekran Sayısı : 0</span>
							</div>
					...
					<!---->
						...
						<div class="pa-6 white--text red-gradient graphDesign">
							<div class="d-custom-flex align-items-center">
								...
								<span class="d-flex font-sm fw-bold justify-center" style="width:100%;">Sinyal Alınamayan Ekran Sayısı : {{ noSignalDeviceLength }}</span>
							</div>
